  ...
  content.innerHTML = `
    ...
    <div class="settings-section">
      ...
      <div class="form-group">
        ...
        <p class="text-sm text-secondary mt-1">切换后在对话页生效，刷新页面恢复默认</p>
      </div>
    ...
    <div class="settings-section">
      ...
      <div class="api-key-status">
        <div class="api-key-row">
          ...
          <span class="text-sm text-secondary">LLM_API_KEY · 文本对话/出题/评判</span>
        </div>
        <div class="api-key-row">
          ...
          <span class="text-sm text-secondary">MULTIMODAL_API_KEY · 图片理解/多模态解析</span>
        </div>
      </div>
      <p class="text-sm text-secondary mt-2">在项目根目录的 .env 文件中配置 API Key，修改后需重启服务</p>
    </div>

    <div class="settings-section">
      <h3>系统信息</h3>
      <p class="text-sm text-secondary">AI 学习助手 v2.1 · 产品 PM 专版</p>
